...
int get_detection(int id);
void detect(mat_cv* mat, detection *dets, int num, float thresh, char **names, image **alphabet, int classes, int ext_output, int benchmark, int dontdraw_bbox);
...
// Draw Detection
//void draw_detections_cv_v3(void** show_img, detection *dets, int num, float thresh, char **names, image **alphabet, int classes, int ext_output);
//void draw_detections_cv_v3(cv::Mat* show_img, detection *dets, int num, float thresh, char **names, image **alphabet, int classes, int ext_output);
